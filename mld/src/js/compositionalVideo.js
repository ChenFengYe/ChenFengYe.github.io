// from https://github.com/dreamfusion3d/dreamfusion3d.github.io/blob/main/assets/js/scripts.js
...
(function () {
  ...
  let imagen_pieces = [
    ...
    [
      ...
      'chopping vegetables',
      'sitting at a pottery wheel shaping a clay bowl',
      'riding a skateboard',
      'wielding a katana',
      'eating a hamburger',
      'dancing',
  ...
  const updateCompositionVideo = () => {
    ...
    if (captions.includes(phrase)) {
      ...
      let sourceURL =
        'https://dreamfusion-cdn.ajayj.com/journey_sept28/cropped/full_continuous/' +
        videoName;
...
(function () {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    let caption = videoPath
      ...
      .replace('_rgbdn_hq_partial_15000.mp4', '')
      .replace('.mp4', '')
      .replaceAll('_', ' ');
